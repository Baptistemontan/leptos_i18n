...
fn cardinal_plural() {
    // count = 0
    let count = move || 0;
    let en = td!(Locale::en, cardinal_plural, count = count);
    assert_eq_rendered!(en, "0 items");
    let fr = td!(Locale::fr, cardinal_plural, count = count);
...
fn ordinal_plural() {
    // count = 1
    let count = move || 1;
    let en = td!(Locale::en, ordinal_plural, count = count);
    assert_eq_rendered!(en, "1st place");
    let fr = td!(Locale::fr, ordinal_plural, count = count);
...
fn args_to_plural() {
    let count = move || 0;
    let en = td!(Locale::en, args_to_plural, count = count);
    assert_eq_rendered!(en, "en 0");
    let fr = td!(Locale::fr, args_to_plural, count = count);
