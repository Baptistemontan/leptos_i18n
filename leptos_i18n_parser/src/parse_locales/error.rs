...
impl Display for Error {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Error::LocaleFileDeser { path, err} => write!(f, "Parsing of file {path:?} failed: {err}"),
            Error::RangeParse {
                range,
                range_type
            ...
            } => write!(f, "the range {range:?} end bound is invalid, you can't use exclusif range with {range_type}"),
            Error::InvalidBoundEnd {
                range,
                range_type
            } => write!(f,
