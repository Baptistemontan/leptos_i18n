...
impl FormatterToTokens for ListFormatter {
    fn view_bounds(&self) -> TokenStream {
        quote!(__l_i18n_crate::__private::ListFormatterInputFn)
    }
    fn to_view(&self, key: &syn::Ident, locale_field: &syn::Ident) -> TokenStream {
        let Self(list_type, list_style) = self;
        quote!(__l_i18n_crate::__private::format_list_to_view(#locale_field, #key, #list_type, #list_style))
    }

    fn fmt_bounds(&self) -> TokenStream {
        quote!(__l_i18n_crate::__private::WriteableList)
    }
...
impl_to_tokens!(
    ListType,
    __l_i18n_crate::__private::ListType,
    {
        And,
        Or,
        Unit
...
impl_to_tokens!(
    ListStyle,
    __l_i18n_crate::reexports::icu::list::options::ListLength,
    {
        Wide,
        Short,
        Narrow
